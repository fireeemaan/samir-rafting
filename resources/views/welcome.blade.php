...
@section('content')
    ...
    <section id="paket" class="py-20 px-6 md:px-20 bg-white">
        <h2 class="text-4xl font-bold text-center mb-12">Paket Rafting</h2>
        <div class="grid md:grid-cols-2 gap-8">
            <div class="bg-gray-100 p-6 rounded-2xl shadow hover:shadow-xl transition">
                <h3 class="text-2xl font-semibold mb-2">Paket 5 KM</h3>
                <p class="text-gray-600 mb-4">Jarak tempuh 5 km, cocok untuk keluarga dan pemula yang ingin merasakan serunya rafting.</p>
                <ul class="text-sm text-gray-700 mb-4 list-disc list-inside">
                    ...
                    <li>Guide & Rescue</li>
                    <li>Foto cetak & Video</li>
                </ul>
                <p class="font-bold text-yellow-500 text-xl mb-4">Rp175.000/pax</p>
                <a href="/booking" class="inline-block bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-4 py-2 rounded-full">Pesan Sekarang</a>
            </div>
            <div class="bg-gray-100 p-6 rounded-2xl shadow hover:shadow-xl transition">
                <h3 class="text-2xl font-semibold mb-2">Paket 7 KM</h3>
                <p class="text-gray-600 mb-4">Jarak tempuh 7 km dengan medan lebih menantang, ideal bagi pencari adrenalin dan tim berpengalaman.</p>
                <ul class="text-sm text-gray-700 mb-4 list-disc list-inside">
                    <li>Welcome Drink</li>
                    <li>Snack</li>
                    <li>Air Mineral</li>
                ...
                <p class="font-bold text-yellow-500 text-xl mb-4">Rp200.000/pax</p>
                <a href="/booking" class="inline-block bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-4 py-2 rounded-full">Pesan Sekarang</a>
            </div>
        </div>
    </section>
